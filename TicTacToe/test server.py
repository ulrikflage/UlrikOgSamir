...
def clicked1():
    global turn
    global cell
    if turn and btn1["text"] == " " and btn1["text"] == " ":
        btn1["text"] = "X"
...
def clicked2():
    global turn
    global cell
    if turn and btn2["text"] == " " and btn2["text"] == " ":
        btn2["text"] = "X"
...
def clicked3():
    global turn
    global cell
    if turn and btn3["text"] == " " and btn3["text"] == " ":
        btn3["text"] = "X"
...
def clicked4():
    global turn
    global cell
    if turn and btn4["text"] == " " and btn4["text"] == " ":
        btn4["text"] = "X"
...
def clicked5():
    global turn
    global cell
    if turn and btn5["text"] == " " and btn5["text"] == " ":
        btn5["text"] = "X"
...
def clicked6():
    global turn
    global cell
    if turn and btn6["text"] == " " and btn6["text"] == " ":
        btn6["text"] = "X"
...
def clicked7():
    global turn
    global cell
    if turn and btn7["text"] == " " and btn7["text"] == " ":
        btn7["text"] = "X"
...
def clicked8():
    global turn
    global cell
    if turn and btn8["text"] == " " and btn8["text"] == " ":
        btn8["text"] = "X"
...
def clicked9():
    global turn
    global cell
    if turn and btn9["text"] == " " and btn9["text"] == " ":
        btn9["text"] = "X"
