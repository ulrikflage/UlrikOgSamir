...
# noinspection PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyPep8,PyBroadException
class Client:
    def __init__(self):
    ...
    def __connect_failed__(self):
        ...
        if choice.lower() == "a":
            ...
            self.port_number = input("Please enter the port:")
...
class ClientGame(Client):
    ...
    def __update_board__(self, command, board_string):
        ...
        if command == "Y":
            ...
            print("Current board:\n" + ClientGame.format_board(self,
                ClientGame.show_board_pos(self, board_string)))
        else:
            # Print out the current board
            print("Current board:\n" + ClientGame.format_board(self, board_string))
...
# noinspection PyPep8,PyPep8,PyBroadException
def main():
